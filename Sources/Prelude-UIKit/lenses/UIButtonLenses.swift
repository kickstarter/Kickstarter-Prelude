...
public extension LensHolder where Object: UIButtonProtocol {
  ...
  func attributedTitle(for state: UIControl.State) -> Lens<Object, NSAttributedString> {
    return Lens(
  ...
  func backgroundColor(for state: UIControl.State) -> Lens<Object, UIColor> {
    return Lens(
      view: { _ in .clear },
  ...
  func image(for state: UIControl.State) -> Lens<Object, UIImage?> {
    return Lens(
  ...
  func titleColor(for state: UIControl.State) -> Lens<Object, UIColor> {
    return Lens(
  ...
  func title(for state: UIControl.State) -> Lens<Object, String?> {
    return Lens(
