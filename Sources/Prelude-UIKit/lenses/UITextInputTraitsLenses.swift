...
public extension LensHolder where Object: UITextInputTraitsProtocol {
  var autocapitalizationType: Lens<Object, UITextAutocapitalizationType> {
    return Lens(
  ...
  var autocorrectionType: Lens<Object, UITextAutocorrectionType> {
    return Lens(
  ...
  var keyboardAppearance: Lens<Object, UIKeyboardAppearance> {
    return Lens(
  ...
  var keyboardType: Lens<Object, UIKeyboardType> {
    return Lens(
      view: { $0.keyboardType },
  ...
  var returnKeyType: Lens<Object, UIReturnKeyType> {
    return Lens(
  ...
  var secureTextEntry: Lens<Object, Bool> {
    return Lens(
  ...
  var spellCheckingType: Lens<Object, UITextSpellCheckingType> {
    return Lens(
