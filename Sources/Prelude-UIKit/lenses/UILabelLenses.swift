...
public extension LensHolder where Object: UILabelProtocol {
  var adjustsFontSizeToFitWidth: Lens<Object, Bool> {
    return Lens(
  ...
  var attributedText: Lens<Object, NSAttributedString?> {
    return Lens(
  ...
  var lineBreakMode: Lens<Object, NSLineBreakMode> {
    return Lens(
  ...
  var minimumScaleFactor: Lens<Object, CGFloat> {
    return Lens(
  ...
  var numberOfLines: Lens<Object, Int> {
    return Lens(
