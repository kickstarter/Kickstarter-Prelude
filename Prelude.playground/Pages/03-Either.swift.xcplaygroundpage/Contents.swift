...
/*:
 ...
 have the user’s `id` or a full `user` value. It is on us to safely handle this situation. For example, suppose
 we wanted to load a fresh version of the user from the API. The following function provides a mocked version
 of such a request:
 */
